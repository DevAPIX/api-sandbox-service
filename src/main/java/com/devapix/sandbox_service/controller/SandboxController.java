...
public class SandboxController {
    ...
    @PostMapping("/execute")
    public ResponseEntity<SandboxResponseDTO> execute(@RequestParam Integer apiId, @RequestParam Integer endpointId,
            @RequestHeader(value = "X-Api-Key", required = false) String apiKey, @Parameter(hidden = true) @RequestHeader("X-User-Id") String userIdStr) {
        ...
        log.info("POST /execute → apiId={}, endpointId={}, userId={}, apiKey={}",
                apiId, endpointId, userId,
